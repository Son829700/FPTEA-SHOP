...
public class UserDAO {
    ...
    private static final String LIST_USER = "SELECT userID, fullName, roleID FROM tblUsers WHERE fullName LIKE ?";
        ...
        try {
            ...
            if (conn != null) {
                ...
                while (rs.next()) {
                    ...
                    String roleID = rs.getString("roleID");
                    String passsword = "******";
                    list.add(new UserDTO(userID, fullName, roleID, passsword));
                }
