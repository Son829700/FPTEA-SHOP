<%-- 
    Document   : footer
    Created on : Jul 5, 2024, 9:42:13 AM
    Author     : User
--%>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-lg-4">
                                        <div class="widget p-3 p-md-4 p-xxl-5">
                                            <h4 class="widget-title mb-4">Contact with us</h4>
                                            <address class="mb-4">Lot E2a-7, Street D1, Đ. D1, Long Thanh My, Thu Duc City, Ho Chi Minh 700000, Vietnam</address>
                                            <p class="mb-1">
                                                <a class="link-dark link-offset-1 link-opacity-75 link-opacity-100-hover link-underline-opacity-0 link-underline-opacity-100-hover" href="tel:+15057922430">FPT University</a>
                                            </p>
                                            <p class="mb-0">
                                                <a class="link-dark link-offset-1 link-opacity-75 link-opacity-100-hover link-underline-opacity-0 link-underline-opacity-100-hover" href="mailto:sonnhse1834354@gmail.com">sonnhse1834354@gmail.com</a>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-lg-4">
                        ...
                        <div class="col">
                            <div class="container-fluid border border-dark">
                                <div class="row gy-4 gy-lg-0 p-3 p-md-4 p-xxl-5 align-items-md-center">
                                    <div class="col-xs-12 col-sm-6 col-lg-3 order-0 order-lg-0">
                                        <div class="footer-logo-wrapper text-center text-sm-start">
                                            <a href="#!">
                                                <img src="img/FPT.svg.png" alt="FPTEA Logo" class="bsb-tpl-logo-footer">
                                            </a>
                                        </div>
                                    </div>

                                    <div class="col-xs-12 col-lg-5 order-2 order-lg-1">
                                    ...
                                    <div class="col-xs-12 col-lg-1 order-2 order-lg-1"></div>

                                    <div class="col-xs-12 col-sm-6 col-lg-3 order-1 order-lg-2">
